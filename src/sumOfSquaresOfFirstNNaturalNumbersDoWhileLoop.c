...
int main()
{
    ...
    do {
        sum += i*i;    // Add the current number to the sum
        i++;         // Increment the counter
    } while (i <= number);    // Continue the loop until we've added the desired number of natural numbers

    // Output the sum of the squares of the natural numbers
    printf("The sum of the squares of the first %lu natural numbers is: %lu\n", number, sum);
